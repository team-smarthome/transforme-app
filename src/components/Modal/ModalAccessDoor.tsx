...
interface ModalAccessDoorProps {
  name: string;
  handleClose: any;
}
import { useNavigate } from "react-router-dom";

function ModalAccessDoor({ name, handleClose }: ModalAccessDoorProps) {
    ...
    <div className="w-full text-white">
      ...
      <div className="flex flex-col md:flex-row gap-x-4 px-10 mb-10">
        <div className="w-24 h-36 ">
          <img
            src="https://images.unsplash.com/photo-1521386455230-4ceaa25b72be?q=80&w=2787&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
            alt="camera"
        ...
        <aside className="flex-1 ">
          ...
          <div className="flex">
            <div className="flex-1 ">
              <p className="font-semibold text-sm">Nama Access Door</p>
            </div>
            <div className="flex-2">
...
export default ModalAccessDoor;
