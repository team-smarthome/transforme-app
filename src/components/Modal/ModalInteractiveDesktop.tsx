...
function ModalInteractiveDesktop({
  name,
  handleClose,
}: ModalInteractiveDesktopProps) {
    ...
    <div className="w-full text-white">
      ...
      <div className="flex flex-col md:flex-row gap-x-4 px-10 mb-10">
        <div className="w-24 h-36 ">
          <img
            src="https://plus.unsplash.com/premium_photo-1681236323432-3df82be0c1b0?q=80&w=2940&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
            alt="camera"
        ...
        <aside className="flex-1 ">
          ...
          <div className="flex">
            <div className="flex-1 ">
              <p className="font-semibold text-sm">Nama Interactive Desktop</p>
            </div>
            <div className="flex-2">
...
export default ModalInteractiveDesktop;
