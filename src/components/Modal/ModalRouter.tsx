...
function ModalRouter({ name, handleClose }: ModalRouterProps) {
    ...
    <div className="w-full text-white">
      ...
      <div className="flex flex-col md:flex-row gap-x-4 px-10 mb-10">
        <div className="w-24 h-36 ">
          <img
            src="https://images.unsplash.com/photo-1606904825846-647eb07f5be2?q=80&w=2940&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
            alt="camera"
        ...
        <aside className="flex-1 ">
          ...
          <div className="flex">
            <div className="flex-1 ">
              <p className="font-semibold text-sm">Nama Router</p>
            </div>
            <div className="flex-2">
