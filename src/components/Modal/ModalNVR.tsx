...
function ModalNVR({ name, handleClose }: ModalNVRProps) {
    ...
    <div className="w-full text-white">
      ...
      <div className="flex flex-col md:flex-row gap-x-4 px-10 mb-10">
        <div className="w-24 h-36 ">
          <img
            src="https://images.unsplash.com/photo-1577538926988-7926820ed209?w=800&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8M3x8TkFTfGVufDB8fDB8fHww"
            alt="camera"
        ...
        <aside className="flex-1 ">
          ...
          <div className="flex">
            <div className="flex-1 ">
              <p className="font-semibold text-sm">Nama Perangkat NVR</p>
            </div>
            <div className="flex-2">
