...
function RoomTemplate({
  ...
  return (
    <div
      onClick={handleClick} 
      className={`absolute ${getSize()}  cursor-pointer hover:bg-slate-200 transition-colors duration-200 ${color} flex justify-between border-black border shadow-md shadow-slate-600 bg-opacity-75 z-[80] `}
    />
