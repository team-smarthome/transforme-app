            ...
            <ul>
              ...
              <li>
                <NavLink
                  ...
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                    pathname === "/statistic" && "bg-graydark dark:bg-meta-4"
                  }`}
                >
                  <svg
                    fill="#FFFFFF"
              ...
              <li>
                <NavLink
                  ...
                  onClick={() => handleNavLinkClick("petas")}
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                    pathname === "/kamera-live" && "bg-graydark dark:bg-meta-4"
                  }`}
                >
                  <svg
                    fill="#FFFFFF"
              ...
              <li>
                <NavLink
				  ...
				  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                    pathname === "/gelang" && "bg-graydark dark:bg-meta-4"
                  }`}
                >
                <svg fill="#fff" width="18" height="18" viewBox="0 0 24 24" id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg"><defs></defs><circle className="cls-1" cx="7.2" cy="12" r="5.73"/><path className="cls-1" d="M9.11,12A1.91,1.91,0,1,1,7.2,10.09"/><polyline className="cls-1" points="2.43 8.84 3.38 1.5 11.02 1.5 11.97 8.84"/><polyline className="cls-1" points="11.97 15.16 11.02 22.5 3.38 22.5 2.43 15.16"/><line className="cls-1" x1="14.84" y1="12" x2="12.93" y2="12"/><path className="cls-1" d="M16.58,9.3a3.82,3.82,0,0,1,0,5.4"/><path className="cls-1" d="M19.13,6.75a7.42,7.42,0,0,1,0,10.5"/></svg>
                  Gelang
                </NavLink>
              </li>
              {/* <!-- Menu Item Gelang --> */}
              ...
              {isSuperAdmin && (
                <li>
                  <NavLink
					...
					className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
						pathname === "/manajemen-pengguna" && "bg-graydark dark:bg-meta-4"
					  }`}
              ...
              <SidebarLinkGroup
                activeCondition={
                  pathname === "/smartwatch" || pathname.includes("smartwatch")
                }
              >
                {(handleClick, open) => (
                  <>
...
<path fill-rule="evenodd" clip-rule="evenodd" d="M7 3V4C5.34315 4 4 5.34315 4 7V17C4 18.6569 5.34315 20 7 20L7 21C7 22.6569 8.34315 24 10 24H14C15.6569 24 17 22.6569 17 21V20C18.6569 20 20 18.6569 20 17V13C20.5523 13 21 12.5523 21 12C21 11.4477 20.5523 11 20 11V7C20 5.34315 18.6569 4 17 4V3C17 1.34315 15.6569 0 14 0H10C8.34315 0 7 1.34315 7 3ZM10 2C9.44772 2 9 2.44772 9 3V4H15V3C15 2.44772 14.5523 2 14 2H10ZM7 18C6.44772 18 6 17.5523 6 17V7C6 6.44771 6.44772 6 7 6H17C17.5523 6 18 6.44772 18 7V17C18 17.5523 17.5523 18 17 18H7ZM9 20H15V21C15 21.5523 14.5523 22 14 22H10C9.44772 22 9 21.5523 9 21V20Z" fill="#fffF"/>
                    ...
                    >
                      <ul className="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6 ml-4">
                        <li>
                          <NavLink
                            to="/smartwatch"
                            onClick={() => handleNavLinkClick("smartwatch")}
                            className={`${"group relative flex items-center gap-2.5 rounded-md px-4 py-2  font-medium text-bodydark2 duration-300 ease-in-out hover:text-white "} ${
                              pathname === "/smartwatch" && "!text-white"
                            }`}
                          >
                            Device
                          </NavLink>
                        ...
                        <li>
                          <NavLink
                            ...
                            onClick={() => handleNavLinkClick("device-type")}
                            className={`${"group relative flex items-center gap-2.5 rounded-md px-4 py-2  font-medium text-bodydark2 duration-300 ease-in-out hover:text-white "} ${
                              pathname === "/smartwatch/device-type" &&
                              "!text-white"
                            }`}
                          >
                            Tipe Device
                        ...
                        <li>
                          <NavLink
                            ...
                            onClick={() => handleNavLinkClick("firmware")}
                            className={`${"group relative flex items-center gap-2.5 rounded-md px-4 py-2  font-medium text-bodydark2 duration-300 ease-in-out hover:text-white "} ${
                              pathname === "/smartwatch/firmware" &&
                              "!text-white"
                            }`}
                          >
                            Firmware
                        ...
                        <li>
                          <NavLink
                            ...
                            onClick={() => handleNavLinkClick("platform")}
                            className={`${"group relative flex items-center gap-2.5 rounded-md px-4 py-2  font-medium text-bodydark2 duration-300 ease-in-out hover:text-white "} ${
                              pathname === "/smartwatch/platform" &&
                              "!text-white"
                            }`}
                          >
                            Platform
                        ...
                        <li>
                          <NavLink
                            ...
                            onClick={() => handleNavLinkClick("manufacture")}
                            className={`${"group relative flex items-center gap-2.5 rounded-md px-4 py-2  font-medium text-bodydark2 duration-300 ease-in-out hover:text-white "} ${
                              pathname === "/smartwatch/manufacture" &&
                              "!text-white"
                            }`}
                          >
                            Manufacture
              ...
              <li>
                <NavLink
				  ...
				  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
					pathname === "/kamera" && "bg-graydark dark:bg-meta-4"
				  }`}
                >
					 <svg
                    fill="#FFFFFF"
              ...
              <li>
                <NavLink
				  ...
				  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
					pathname === "/gateway" && "bg-graydark dark:bg-meta-4"
				  }`}
                >
...
<path d="M14.4762 6.71292C14.2768 6.90911 14.1223 7.10809 14.0182 7.2579C13.6696 7.75991 13.1966 8.23817 12.5294 7.88235C11.9766 7.58751 11.8923 6.8973 12.193 6.39806C12.2358 6.327 12.2967 6.23053 12.3755 6.1171C12.5319 5.89191 12.7649 5.59089 13.0738 5.28708C13.6809 4.68987 14.6689 4 15.9999 4C17.3309 4 18.3189 4.68986 18.9261 5.28706C19.235 5.59087 19.468 5.89188 19.6244 6.11707C19.7031 6.2305 19.764 6.32697 19.8069 6.39803C20.1082 6.8983 20.0212 7.58858 19.4705 7.88233C18.8032 8.23829 18.3304 7.76001 17.9817 7.25793C17.8776 7.10812 17.7231 6.90913 17.5236 6.71294C17.1141 6.31014 16.6021 6 15.9999 6C15.3977 6 14.8857 6.31013 14.4762 6.71292Z" fill="#fff"/>
<path d="M5 18C4.44772 18 4 18.4477 4 19C4 19.5523 4.44772 20 5 20C5.55228 20 6 19.5523 6 19C6 18.4477 5.55228 18 5 18Z" fill="#fff"/>
<path d="M7 19C7 18.4477 7.44771 18 8 18C8.55229 18 9 18.4477 9 19C9 19.5523 8.55229 20 8 20C7.44771 20 7 19.5523 7 19Z" fill="#fff"/>
<path d="M10 19C10 18.4477 10.4477 18 11 18C11.5523 18 12 18.4477 12 19C12 19.5523 11.5523 20 11 20C10.4477 20 10 19.5523 10 19Z" fill="#fff"/>
<path fill-rule="evenodd" clip-rule="evenodd" d="M15 8C15 7.44771 15.4477 7 16 7C16.5523 7 17 7.44771 17 8V15H20C21.6569 15 23 16.3431 23 18V20C23 21.6569 21.6569 23 20 23H4C2.34315 23 1 21.6569 1 20V18C1 16.3431 2.34315 15 4 15H15V8ZM20 17C20.5523 17 21 17.4477 21 18V20C21 20.5523 20.5523 21 20 21H4C3.44772 21 3 20.5523 3 20V18C3 17.4477 3.44772 17 4 17H20Z" fill="#fff"/>
</svg>
                  Gateway
                </NavLink>
              </li>
            ...
            <path d="M12,8 C13.6569,8 15,9.34315 15,11 C15,12.3371217 14.1252318,13.4699388 12.9168031,13.8573433 L12.75,13.9055 L12.75,16 L18,16 C19.6569,16 21,17.3431 21,19 C21,20.597725 19.7511226,21.903664 18.1762773,21.9949075 L18,22 L6,22 C4.34315,22 3,20.6569 3,19 C3,17.402275 4.24892392,16.096336 5.82372764,16.0050925 L6,16 L11.25,16 L11.25,13.9055 C9.95608,13.5725 9,12.3979 9,11 C9,9.34315 10.3431,8 12,8 Z M18,17.5 L6,17.5 C5.17157,17.5 4.5,18.1716 4.5,19 C4.5,19.8284 5.17157,20.5 6,20.5 L18,20.5 C18.8284,20.5 19.5,19.8284 19.5,19 C19.5,18.1716 18.8284,17.5 18,17.5 Z M12,9.5 C11.1716,9.5 10.5,10.1716 10.5,11 C10.5,11.8284 11.1716,12.5 12,12.5 C12.8284,12.5 13.5,11.8284 13.5,11 C13.5,10.1716 12.8284,9.5 12,9.5 Z M12,2 C16.9706,2 21,6.02944 21,11 L21,11.25 C21,11.6642 20.6642,12 20.25,12 C19.8358,12 19.5,11.6642 19.5,11.25 L19.5,11 C19.5,6.85786 16.1421,3.5 12,3.5 C7.85786,3.5 4.5,6.85786 4.5,11 L4.5,11.25 C4.5,11.6642 4.16421,12 3.75,12 C3.33579,12 3,11.6642 3,11.25 L3,11 C3,6.02944 7.02944,2 12,2 Z M12,5 C15.3137,5 18,7.68629 18,11 L18,11.25 C18,11.6642 17.6642,12 17.25,12 C16.8358,12 16.5,11.6642 16.5,11.25 L16.5,11 C16.5,8.51472 14.4853,6.5 12,6.5 C9.51472,6.5 7.5,8.51472 7.5,11 L7.5,11.25 C7.5,11.6642 7.16421,12 6.75,12 C6.33579,12 6,11.6642 6,11.25 L6,11 C6,7.68629 8.68629,5 12,5 Z" id="🎨-Color">
              ...
              <li>
                <NavLink
				  ...
				  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
					pathname === "/nas" && "bg-graydark dark:bg-meta-4"
				  }`}
                >
  ...
  <g id="Layer_2" data-name="Layer 2">
    ...
    <g id="icons_Q2" data-name="icons Q2" fill="#fff">
      <g>
