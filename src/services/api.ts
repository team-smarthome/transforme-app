...
export const webserviceurl = "http://dev-siram-dashboard.transforme.co.id/api/";

const newBaseUrl = "http://dev-siram-dashboard.transforme.co.id/api";
...
export function apiUserLogin(params) {
  console.log("urlLogin", webserviceurl);
  try {
...
export function apiUserRegister(params) {
  try {
    const response = axios({
      method: "post",
      url: webserviceurl + "/siram-test/user_register.php",
      data: params,
      headers: {
...
export function apiIndoorMapV2() {
  try {
    const response = axios({
      ...
      url:
        webserviceurl +
        "indoor_map?lokasi_otmil_id=890cc9b1-b01f-4d1f-9075-a6a96e851b25",
      headers: {
        "Content-Type": "application/json",
        Authorization:
...
export async function apiReadAllRuanganOtmil(params, token) {
  try {
    const response = await axios({
      method: "get",
      url: webserviceurl + "ruangan_otmil",
      params,
      headers: {
        "Content-Type": "application/json",
        Authorization: `Bearer ${token}`,
...
export async function apiReadOneKamera(params) {
  try {
    const response = await axios({
      method: "POST",
      url: webserviceurl + "siram_api/kamera_read_one.php",
      data: params,
    });
    console.log(response);
    return response;
...
export async function apiReadKasus(params, token) {
  ...
  // const url = webserviceurl + "" + `kasus?${queryString}`;
  try {
    const response = await axios({
      method: "get",
...
export async function apiReadPenyidikan(params, token) {
  // const queryString = getUrl(params);
  // const url = webserviceurl + "" + `penyidikan?${queryString}`;
  // console.log('urlPenyidikan', queryString);
  try {
    const response = await axios({
      method: "get",
      // url: url,
      url: webserviceurl + "penyidikan",
      params,
      headers: {
        "Content-Type": "application/json",
        Authorization: `Bearer ${token}`,
...
export async function apiReadJaksaPenyidik(params, token) {
  const queryString = getUrl(params);
  const url = webserviceurl + `oditur_penyidik?${queryString}`;
  try {
    const response = await axios({
      method: "get",
      url: url,
...
export async function apiReadSaksi(params, token) {
  // const queryString = getUrl(params);
  // const url = webserviceurl + `saksi?${queryString}`;
  try {
    const response = await axios({
      method: "get",
...
export async function apiReadStatusWBP(params, token) {
  try {
    const response = await axios({
      method: "get",
      url: webserviceurl + "status_wbp_kasus",
      headers: {
        "Content-Type": "application/json",
        Authorization: `Bearer ${token}`,
      },
...
export async function apiReadjenisperkara(params, token) {
  // const queryString = getUrl(params);
  // const url = webserviceurl + `jenis_perkara?${queryString}`;
  try {
    const response = await axios({
      method: "get",
      url: webserviceurl + "jenis_perkara",
      params,
      headers: {
        "Content-Type": "application/json",
        Authorization: `Bearer ${token}`,
...
export async function apiJenisPidanaRead(params, token) {
  const queryString = getUrl(params);
  const url = webserviceurl + `jenis_pidana?${queryString}`;
  try {
    const response = await axios({
      method: "get",
      url: url,
...
export async function apiJaksaRead(params, token) {
  try {
    const response = await axios({
      method: "post",
      url: webserviceurl + "siram_api/jaksa_read.php",
      data: params,
      headers: {
        "Content-Type": "application/json",
        Authorization: `Bearer ${token}`,
...
export async function apiPengadilanMiliterRead(params, token) {
  try {
    const response = await axios({
      method: "get",
      url: webserviceurl + "pengadilan_militer",
      params,
      headers: {
        "Content-Type": "application/json",
        Authorization: `Bearer ${token}`,
...
export async function apiReadAllRole(token) {
  ...
  try {
    const response = await axios({
      method: "get",
      // url: webserviceurl + "siram_api/user_role_read.php",
      url: webserviceurl + "user_role",
      // data: params,
      headers: {
        "Content-Type": "application/json",
        Authorization: `Bearer ${token}`,
...
export async function apiReadAllUser(params, token) {
  ...
  try {
    const response = await axios({
      method: "get",
      url: url,
      // url: webserviceurl + '/user_read.php',
      // data: params,
      headers: {
        "Content-Type": "application/json",
        // 'Content-Type' : 'application/x-www-form-urlencoded; charset=UTF-8',
...
export async function apiReadJaksapenuntut(params, token) {
  try {
    const response = await axios({
      method: "get",
      url: webserviceurl + "oditur_penuntut",
      params,
      headers: {
        "Content-Type": "application/json",
        Authorization: `Bearer ${token}`,
...
export async function apiKeahlian(token) {
  try {
    const response = await axios({
      method: "get",
      url: webserviceurl + "bidang_keahlian",
      data: {},
      headers: {
        "Content-Type": "application/json",
        Authorization: `Bearer ${token}`,
...
export async function apiKota(token) {
  ...
  try {
    const response = await axios({
      method: "get",
      url: webserviceurl + "kota?pageSize=1000",
      // data: {},
      headers: {
        "Content-Type": "application/json",
        Authorization: `Bearer ${token}`,
...
export async function apiMatraRead(params, token) {
  try {
    const response = await axios({
      method: "get",
      url: webserviceurl + `matra?pageSize=99999`,
      // data: params,
      headers: {
        "Content-Type": "application/json",
        Authorization: `Bearer ${token}`,
...
export async function apiProvinsi(token) {
  try {
    const response = await axios({
      method: "get",
      url: webserviceurl + "provinsi?pageSize=1000",
      // data: {},
      headers: {
        "Content-Type": "application/json",
        Authorization: `Bearer ${token}`,
...
export async function apiStatusKawin(token) {
  try {
    const response = await axios({
      method: "get",
      url: webserviceurl + "status_kawin",
      data: {},
      headers: {
        "Content-Type": "application/json",
        Authorization: `Bearer ${token}`,
...
export async function apiChangePassword(params, token) {
  try {
    const response = await axios({
      method: "post",
      url: webserviceurl + "siram_api/user_password_update.php",
      data: params,
      headers: {
        "Content-Type": "application/json",
        Authorization: `Bearer ${token}`,
...
export async function apiDeleteDaftarKasus(params, token) {
  try {
    const response = await axios({
      method: "delete",
      url: webserviceurl + "kasus?kasus_id=" + params.kasus_id,
      // data: params,
      headers: {
        "Content-Type": "application/json",
        Authorization: `Bearer ${token}`,
...
export async function apiCreateAktifitasPengunjung(params, token) {
  try {
    const response = await axios({
      method: "post",
      url: webserviceurl + "aktivitas_pengunjung",
      data: params,
      headers: {
        "Content-Type": "application/json",
        Authorization: `Bearer ${token}`,
...
export async function apiReadAllRekapJamKerja(params, token) {
  try {
    const response = await axios({
      method: "GET",
      url: webserviceurl + "rekap_jam_kerja_lembur",
      params,
      headers: {
        "Content-Type": "application/json",
        Authorization: `Bearer ${token}`,
...
export async function apiCreateKategoriPerkara(params, token) {
  try {
    const response = await axios({
      ...
      url: webserviceurl + `kategori_perkara`,
      data: params,
      headers: {
        "Content-Type": "application/json",
        Authorization: `Bearer ${token}`,
...
export async function apiDeleteKategoriPerkara(params, token) {
  try {
    const response = await axios({
      method: "delete",
      // url: webserviceurl + 'siram_api/kategori_perkara_delete.php',
      url:
        webserviceurl +
...
export async function apiReadKategoriPerkara(params, token) {
  ...
  // const queryString = getUrl(params);
  // const url = webserviceurl + `kategori_perkara?${queryString}`;
  try {
    const response = await axios({
      method: "get",
      // url: webserviceurl + 'siram_api/kategori_perkara_read.php',
      // data: params,
      url: webserviceurl + "kategori_perkara",
      params,
      headers: {
...
export async function apiCreatePengadilanMiliter(params, token) {
  try {
    const response = await axios({
      method: "post",
      // url: webserviceurl + 'siram_api/pengadilan_militer_insert.php',
      url: webserviceurl + `pengadilan_militer`,
      data: params,
      headers: {
        "Content-Type": "application/json",
...
export async function apiUpdatePengadilanMiliter(params, token) {
  try {
    const response = await axios({
      method: "put",
      // url: webserviceurl + 'siram_api/pengadilan_militer_update.php',
      url: webserviceurl + `pengadilan_militer`,
      data: params,
      headers: {
        "Content-Type": "application/json",
...
export async function apiDeletePengadilanMiliter(params, token) {
  try {
    const response = await axios({
      method: "delete",
      // url: webserviceurl + 'siram_api/pengadilan_militer_delete.php',
      url:
        webserviceurl +
...
export async function allKameraOtmil() {
  try {
    const response = await axios({
      method: "post",
      url: webserviceurl + "siram_api/kamera_read_all_otmil.php",
      headers: {
        "Content-Type": "application/json",
      },
    });
...
export async function allKameraOtmilByLocation(token) {
  ...
  try {
    const response = await axios({
      method: "post",
      url: webserviceurl + "siram_api/kamera_read_by_location.php",
      data: otmil,
      headers: {
        "Content-Type": "application/json",
        Authorization: `Bearer ${token}`,
...
export async function apiGedungOtmilRead(params, token) {
  try {
    const response = await axios({
      ...
      // url: webserviceurl + "/gedung_otmil",
      params,
      headers: {
        "Content-Type": "application/json",
        Authorization: `Bearer ${token}`,
...
export async function apiReadAllEvent(params, token) {
  // const queryString = getUrl(params);
  // const url = webserviceurl + `kegiatan?${queryString}`;
  try {
    const response = await axios({
      method: "get",
      url: webserviceurl + "kegiatan",
...
export async function apiUpdateAllEvent(params, token) {
  try {
    const response = await axios({
      method: "put",
      // url: webserviceurl + 'siram_api/kegiatan_update.php',
      url: webserviceurl + `kegiatan`,
      params,
      headers: {
        "Content-Type": "application/json",
...
export async function apiDeleteAllEvent(params, token) {
  try {
    const response = await axios({
      method: "delete",
      // url: webserviceurl + 'siram_api/kegiatan_delete.php',
      // data: params,
      url: webserviceurl + `kegiatan?kegiatan_id=` + params.kegiatan_id,
      headers: {
        "Content-Type": "application/json",
        Authorization: `Bearer ${token}`,
      },
...
export async function apiCreateAllEvent(params, token) {
  try {
    const response = await axios({
      method: "post",
      // url: webserviceurl + 'siram_api/kegiatan_insert.php',
      url: webserviceurl + `kegiatan`,
      params,
      headers: {
        "Content-Type": "application/json",
...
export async function apiCreateUser(params, token) {
  try {
    const response = await axios({
      method: "post",
      // url: webserviceurl + "siram_api/user_insert.php",
...
export async function apiEditUser(params, token) {
  try {
    const response = await axios({
      method: "put",
      // url: webserviceurl + "siram_api/user_update.php",
      url: webserviceurl + "users",
      data: params,
      headers: {
        "Content-Type": "application/json",
...
export async function apiNewDeleteUser(params, token) {
  try {
    const response = await axios({
      method: "delete",
      // url: webserviceurl + "siram_api/user_delete.php",
      url: webserviceurl + "users",
      data: params,
      headers: {
        "Content-Type": "application/json",
...
export async function apiPelacakanTersangka(params, token) {
  try {
    const response = await axios({
      method: "post",
      url: webserviceurl + "siram_api/filter_tersangka.php",
      data: params,
      headers: {
        "Content-Type": "application/json",
        Authorization: `Bearer ${token}`,
...
export async function apiDeleteNvr(params, token) {
  try {
    const response = await axios({
      method: "delete",
      url: webserviceurl + "nvr",
...
export async function apiUpdateNvr(params, token) {
  try {
    const response = await axios({
      method: "put",
      url: webserviceurl + "nvr",
...
export async function apiCreateNvr(params, token) {
  try {
    const response = await axios({
      method: "post",
      url: webserviceurl + "nvr",
...
export async function apiRealtimeLog(params, token) {
  try {
    const response = await axios({
      method: "post",
      url: webserviceurl + "siram_api/kamera_log_read.php",
      data: params,
      headers: {
        "Content-Type": "application/json",
        Authorization: `Bearer ${token}`,
...
export async function apiGatewayLog(params, token) {
  try {
    const response = await axios({
      method: "get",
      // url: webserviceurl + "siram_api/gateway_log_read.php",
      url: webserviceurl + "gateway_log",
      data: params,
      headers: {
        "Content-Type": "application/json",
        Authorization: `Bearer ${token}`,
...
export async function apiReadHakim(params, token) {
  try {
    const response = await axios({
      method: "post",
      url: webserviceurl + "siram_api/hakim_read.php",
      data: params,
      headers: {
        "Content-Type": "application/json",
        Authorization: `Bearer ${token}`,
...
export async function apiCreateHakim(params, token) {
  try {
    const response = await axios({
      method: "post",
      url: webserviceurl + "siram_api/hakim_insert.php",
      data: params,
      headers: {
        "Content-Type": "application/json",
        Authorization: `Bearer ${token}`,
...
export async function apiUpdateHakim(params, token) {
  try {
    const response = await axios({
      method: "post",
      url: webserviceurl + "siram_api/hakim_update.php",
      data: params,
      headers: {
        "Content-Type": "application/json",
        Authorization: `Bearer ${token}`,
...
export async function apiDeleteHakim(params, token) {
  try {
    const response = await axios({
      method: "post",
      url: webserviceurl + "siram_api/hakim_delete.php",
      data: params,
      headers: {
        "Content-Type": "application/json",
        Authorization: `Bearer ${token}`,
...
export async function apiReadAllLokasi(token) {
  try {
    const response = await axios({
      method: "get",
      url: webserviceurl + "lokasi_kesatuan",
      // data: {},
      headers: {
        "Content-Type": "application/json",
        Authorization: `Bearer ${token}`,
...
export function apiIndoorMapVVIP() {
  try {
    const response = axios({
      ...
      // url: webserviceurl + "/indoor_mapV3?lokasi_otmil_id=890cc9b1-b01f-4d1f-9075-a6a96e851b25",
      headers: {
        "Content-Type": "application/json",
        Authorization:
          "Bearer 4|6xeb8BLbbBlzLl7oZyfkZme4Gj3q3PrsRLiCR3Dmcd316fae",
