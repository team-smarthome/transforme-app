					...
					<div className="flex flex-row space-x-4 space-x">
						<div>
							<button
								...
								onClick={() =>
									navigate("/workstation/penyidikan")
								}
							>
								Penyidikan
							</button>
				...
				>
					...
					<div className="flex flex-col items-center">
						<div
							className="p-2.5 xl:p-5 justify-center flex"
							onClick={() =>
								handleButtonFilter("tanggal_pelaporan")
							}
						>
							<h5 className="text-sm font-medium uppercase xsm:text-base">
								Tanggal Pelaporan
						...
						{searchTanggalPelaporan && (
							<div className="w-[80%] search">
								<SearchInputButton
									...
									// placehorder="Cari Nama Kasus"
									onChange={
										handleFilterChangeTanggalPelaporan
									}
								/>
							</div>
						)}
					...
					<div className="flex flex-col items-center">
						<div
							className="p-2.5 xl:p-5 justify-center flex"
							onClick={() =>
								handleButtonFilter("tanggal_kejadian")
							}
						>
							<h5 className="text-sm font-medium uppercase xsm:text-base">
								Tanggal Kejadian
			...
			{data.length === 0 ? null : (
				<div className="mt-5">
					<div className="flex gap-4 items-center ">
						<p>
							Total Rows: {rows} Page: {rows ? currentPage : null}{" "}
							of {pages}
						</p>
						<select
							value={pageSize}
