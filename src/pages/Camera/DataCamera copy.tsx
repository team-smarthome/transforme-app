...
const DataCamera = (props) => {
	...
	const client = useRef(new W3CWebSocket("ws://10.34.7.43:5000"));
	const clientFR = useRef(new W3CWebSocket("ws://10.34.7.43:5000"));
	...
	return (
		<>
			<h1 className="font-semibold ">
				...
				{deviceDetail.nama_ruangan_otmil &&
					deviceDetail.nama_ruangan_otmil}
				{deviceDetail.nama_ruangan_lemasmil &&
					deviceDetail.nama_ruangan_lemasmil}
				-{" "}
				{deviceDetail.nama_lokasi_otmil &&
					deviceDetail.nama_lokasi_otmil}
