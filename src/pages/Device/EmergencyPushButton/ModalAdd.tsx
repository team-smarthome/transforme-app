...
export const AddEmergencyPushButton: React.FC<AddGatewayModalProps> = ({
	closeModal,
	onSubmit,
	defaultValue,
	isDetail,
			...
			steps: [
				{
					element: ".i-nama",
					popover: {
						title: "Nama Emergency Push Button",
						description: "Isi nama emergency push button access",
					},
				},
				{
					element: ".i-gmac",
				...
				},
				{
					element: ".p-status",
					popover: {
						title: "Status AutoGate Single",
						description: "Pilih status emergency push button yang diinginkan",
					},
				},
				{
					element: ".p-ruang",
							...
							<div className="w-full flex justify-between">
								<div>
									<h3 className="text-xl font-semibold text-black dark:text-white">
										{isDetail
											? "Detail Data Emergency Push Button"
											: isEdit
											? "Edit Data Emergency Push Button"
											: "Tambah Data Emergency Push Button"}
									</h3>
								</div>
								...
								<div className="mt-5 grid grid-cols-2 gap-x-5 gap-y-1 justify-normal">
									<div className="form-group w-full h-22">
										...
										<input
											...
											name="nama_emergency_push_button"
											placeholder="Nama Emergency Push Button"
											onChange={handleChange}
											value={formState.nama_emergency_push_button}
											disabled={isDetail}
										/>
									...
									<div className="form-group w-full h-22">
										...
										<select
											...
											onChange={handleChange}
											value={formState.status_emergency_push_button}
											disabled={isDetail}
										>
								...
								>
									...
									{isDetail ? null : isEdit ? (
										...
										>
											...
											Ubah Data Emergency Push Button
										</button>
									) : (
										<button
											className={`items-center btn flex w-full justify-center rounded bg-primary py-2 px-6 font-medium text-gray hover:shadow-1 ${
