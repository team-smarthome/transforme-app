...
import { AddAutoGateSingle } from "./ModalAdd";
...
interface Item {
	gmac: string;
	nama_autogate_single: string;
	status_autogate_single: string;
...
const AutoGateSingleSystemList = () => {
			...
			steps: [
				{
					...
					popover: {
						title: "Search",
						description: "Mencari nama Auto Gate Single",
					},
				},
				{
					element: "#p-status",
				...
				},
				{
					...
					popover: {
						title: "Button Search",
						description: "Click button untuk mencari nama auto gate single",
					},
				},
				{
					element: ".excel",
				...
				},
				{
					...
					popover: {
						title: "Tambah",
						description: "Menambah data perangkat autogate single",
					},
				},
			],
		});
	...
	const exportToExcel = async () => {
		const dataToExcel = [
			[
				"Nama AutoGate Single",
				"GMAC",
				"status autogatesingle",
				"Nama Lokasi Otmil",
				"Nama Ruangan Otmil",
				// "Zona",
			],
		...
		xlsx.writeFile(
			wb,
			`Data-AutoGate Single ${dayjs(new Date()).format("DD-MM-YYYY HH.mm")}.xlsx`
		);
	};
			...
			<div className="rounded-sm border border-stroke bg-white px-5 pt-6 pb-2.5 shadow-default dark:border-strokedark dark:bg-boxdark sm:px-7.5 xl:pb-1">
					...
					<div className="mb-4 flex gap-2 items-center border-[1px] border-slate-800 px-4 py-2 rounded-md">
						<div className="flex w-full">
							<div className="search">
								<SearchInputButton
									value={filter}
									placehorder="Cari nama Auto Gate Single"
				...
				<div className="flex justify-between items-center mb-3">
					<h4 className="ext-xl font-semibold text-black dark:text-white">
						Data Perangkat Autogate Single
					</h4>
					{!isOperator && (
						<button
...
export default AutoGateSingleSystemList;
