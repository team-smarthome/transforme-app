...
export const AddAutoGateSingle: React.FC<AddGatewayModalProps> = ({
	closeModal,
	onSubmit,
	defaultValue,
	isDetail,
			...
			steps: [
				{
					element: ".i-nama",
					popover: {
						title: "Nama Auto Gate Single",
						description: "Isi nama auto gate single",
					},
				},
				{
					element: ".i-gmac",
				...
				},
				{
					...
					popover: {
						...
						description: "Pilih status auto gate single yang diinginkan",
					},
				},
				{
					element: ".p-ruang",
							...
							<div className="w-full flex justify-between">
								<div>
									<h3 className="text-xl font-semibold text-black dark:text-white">
										{isDetail
											? "Detail Data Auto Gate Single"
											: isEdit
											? "Edit Data Auto Gate Single"
											: "Tambah Data Auto Gate Single"}
									</h3>
								</div>
