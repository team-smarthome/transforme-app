...
import { AddNVR } from "./ModalAddNvr";
import { DeleteNVRModal } from "./ModalDeleteNvr";
import { Alerts } from "./AlertNvr";
import { 
  apiReadGateway, 
  apiDeleteGateway, 
  apiCreateGateway, 
...
const NVRList = () => {
    ...
    const driverObj = driver({
      ...
      steps: [
        ...
        },
        {
          ...
          popover: {
            title: "Button Search",
            description: "Click button untuk mencari nama nvr",
          },
        },
        {
          element: ".excel",
        ...
        },
        {
          ...
          popover: {
            title: "Tambah",
            description: "Menambah data perangkat nvr",
          },
        },
      ],
    });
  ...
  const exportToExcel = async () => {
    const dataToExcel = [
      ["nama nvr", "GMAC", "status nvr", "Nama Lokasi Otmil", "Nama Ruangan Otmil"],
    ...
    xlsx.writeFile(wb, `Data-nvr ${dayjs(new Date()).format("DD-MM-YYYY HH.mm")}.xlsx`);
  };
    ...
    <div className="container py-[16px]">
      ...
      <div className="rounded-sm border border-stroke bg-white px-5 pt-6 pb-2.5 shadow-default dark:border-strokedark dark:bg-boxdark sm:px-7.5 xl:pb-1">
          ...
          <div className="mb-4 flex gap-2 items-center border-[1px] border-slate-800 px-4 py-2 rounded-md">
            <div className="flex w-full">
              <div className="search">
                <SearchInputButton value={filter} placehorder="Cari nama NVR" onChange={handleFilterChange} />
              </div>
              <select
        ...
        <div className="flex justify-between items-center mb-3">
          <h4 className="ext-xl font-semibold text-black dark:text-white">Data Perangkat NVR</h4>
          {!isOperator && (
        ...
        <div className="flex flex-col">
          <div className={`grid  rounded-t-md bg-gray-2 dark:bg-slate-600 ${isOperator ? "grid-cols-5" : "grid-cols-6"}`}>
            <div className="p-2.5 text-center xl:p-5">
              <h5 className="text-sm font-medium uppercase xsm:text-base">Nama NVR</h5>
            </div>
            <div className="p-2.5 text-center xl:p-5">
              <h5 className="text-sm font-medium uppercase xsm:text-base">Model NVR</h5>
            </div>
            <div className="p-2.5 text-center xl:p-5">
              <h5 className="text-sm font-medium uppercase xsm:text-base">Tipe NVR</h5>
            </div>
            <div className="p-2.5 text-center xl:p-5">
          ...
          {modalDetailOpen && <AddNVR closeModal={() => setModalDetailOpen(false)} onSubmit={handleSubmitAdd} defaultValue={detailData} isDetail={true} />}
          {modalEditOpen && <AddNVR closeModal={handleCloseEditModal} onSubmit={handleSubmitEdit} defaultValue={editData} isEdit={true} />}
          {modalAddOpen && <AddNVR closeModal={handleCloseAddModal} onSubmit={handleSubmitAdd} />}
          {modalDeleteOpen && <DeleteNVRModal closeModal={handleCloseDeleteModal} onSubmit={handleSubmitDelete} defaultValue={deleteData} />}
        </div>
