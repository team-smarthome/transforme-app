...
export const AddNVR: React.FC<AddNVRModalProps> = ({ closeModal, onSubmit, defaultValue, isDetail, isEdit }) => {
          ...
          {isLoading ? (
            ...
            <div className="border-b border-stroke py-4 px-7 dark:border-strokedark">
              <div className="w-full flex justify-between">
                <div>
                  <h3 className="text-xl font-semibold text-black dark:text-white">{isDetail ? "Detail Data NVR" : isEdit ? "Edit Data NVR" : "Tambah Data NVR"}</h3>
                </div>
