...
export const AddNVR: React.FC<AddNVRModalProps> = ({
  closeModal,
  onSubmit,
  defaultValue,
  isDetail,
                ...
                <div className="mt-5 grid grid-cols-2 gap-x-5 gap-y-1 justify-normal">
                  <div className="form-group w-full h-22">
                    ...
                    <input
                      ...
                      value={formState.nama_nvr}
                      disabled={isDetail}
                    />
                    <p className="error-text p-0 m-0">
                      {errors.map((item) =>
                        item === "nama_nvr" ? "Pilih Desktop" : ""
                      )}
                    </p>
                  </div>
                  ...
                  <div className="form-group w-full h-22">
                    ...
                    <p className="error-text">
                      {errors.map((item) =>
                        item === "status_nvr" ? "Pilih Status Desktop" : ""
                      )}
                    </p>
                  </div>
