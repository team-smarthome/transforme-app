...
// interface
interface AddFaceRecModalProps {
  closeModal: () => void;
...
export const AddFaceRec: React.FC<AddFaceRecModalProps> = ({ closeModal, onSubmit, defaultValue, isDetail, isEdit }) => {
    ...
    const driverObj = driver({
      ...
      steps: [
        ...
        },
        {
          element: ".p-status",
          popover: {
            title: "Status Face Rec",
            description: "Pilih status Face Rec yang diinginkan",
          },
        },
        {
          element: ".p-ruang",
        ...
        },
        {
          ...
          popover: {
            ...
            description: `Klik untuk ${isEdit ? "mengubah" : "menambahkan"} data face rec`,
          },
        },
      ],
    });
              ...
              <div className="w-full flex justify-between">
                <div>
                  <h3 className="text-xl font-semibold text-black dark:text-white">
                    {
                      isDetail ? "Detail Data Face Rec" : 
                      isEdit ? "Edit Data Face Rec" : 
                      "Tambah Data Face Rec"
                    }
                  </h3>
                </div>
