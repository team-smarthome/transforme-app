...
export const AddSmartLocker: React.FC<AddGatewayModalProps> = ({
	closeModal,
	onSubmit,
	defaultValue,
	isDetail,
			...
			steps: [
				{
					element: ".i-nama",
					popover: {
						title: "Nama Smart Locker",
						description: "Isi nama smart locker access",
					},
				},
				{
					element: ".i-gmac",
				...
				},
				{
					...
					popover: {
						...
						description: "Pilih status smart locker yang diinginkan",
					},
				},
				{
					element: ".p-ruang",
							...
							<div className="w-full flex justify-between">
								<div>
									<h3 className="text-xl font-semibold text-black dark:text-white">
										{isDetail
											? "Detail Data Smart Locker"
											: isEdit
											? "Edit Data Smart Locker"
											: "Tambah Data Smart Locker"}
									</h3>
								</div>
								...
								<div className="mt-5 grid grid-cols-2 gap-x-5 gap-y-1 justify-normal">
									<div className="form-group w-full h-22">
										...
										<input
											...
											name="nama_smartlocker"
											placeholder="Nama Smart Locker"
											onChange={handleChange}
											value={formState.nama_smartlocker}
											disabled={isDetail}
										/>
									...
									<div className="form-group w-full h-22">
										...
										<select
											...
											onChange={handleChange}
											value={formState.status_smartlocker}
											disabled={isDetail}
										>
