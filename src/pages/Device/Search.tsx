  ...
  return (
    <div className="flex flex-row">
      <input
        ...
        value={value}
        onChange={onChange}
        className="w-full rounded border border-stroke py-1 px-4 text-black text-sm focus:border-primary focus-visible:outline-none dark:border-strokedark dark:bg-slate-700 dark:text-white dark:focus:border-primary"
