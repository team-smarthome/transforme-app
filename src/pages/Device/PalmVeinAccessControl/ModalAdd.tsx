...
export const AddPalmVeinAccess: React.FC<AddGatewayModalProps> = ({
	closeModal,
	onSubmit,
	defaultValue,
	isDetail,
			...
			steps: [
				{
					element: ".i-nama",
					popover: {
						title: "Nama Palm Vein Access",
						description: "Isi nama palm vein access",
					},
				},
				{
					element: ".i-gmac",
				...
				},
				{
					...
					popover: {
						...
						description: "Pilih status palm vein access yang diinginkan",
					},
				},
				{
					element: ".p-ruang",
							...
							<div className="w-full flex justify-between">
								<div>
									<h3 className="text-xl font-semibold text-black dark:text-white">
										{isDetail
											? "Detail Data Palm Vein Access"
											: isEdit
											? "Edit Data Palm Vein Access"
											: "Tambah Data Palm Vein Access"}
									</h3>
								</div>
