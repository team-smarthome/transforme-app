...
// interface
interface AddAccessDoorModalProps {
	closeModal: () => void;
...
export const AddAccessDoor: React.FC<AddAccessDoorModalProps> = ({
	closeModal,
	onSubmit,
	defaultValue,
	isDetail,
			...
			steps: [
				{
					element: ".i-nama",
					popover: {
						title: "Nama Access Door",
						description: "Isi nama Access Door",
					},
				},
				{
					element: ".i-gmac",
				...
				},
				{
					element: ".p-status",
					popover: {
						title: "Status Access Door",
						description: "Pilih status Access Door yang diinginkan",
					},
				},
				{
					element: ".p-ruang",
							...
							<div className="w-full flex justify-between">
								<div>
									<h3 className="text-xl font-semibold text-black dark:text-white">
										{isDetail
											? "Detail Data Accessdoor"
											: isEdit
											? "Edit Data Accessdoor"
											: "Tambah Data Accessdoor"}
									</h3>
								</div>
								...
								<div className="mt-5 grid grid-cols-2 gap-x-5 gap-y-1 justify-normal">
									<div className="form-group w-full h-22">
										...
										<input
											...
											name="nama_access_door"
											placeholder="Nama Accessdoor"
											onChange={handleChange}
											value={formState.nama_access_door}
											disabled={isDetail}
										/>
									...
									{/* <div className="form-group w-full h-22">
										...
										<input
											className="w-full rounded border border-stroke  py-[11px] pl-3 pr-4.5 text-black focus:border-primary focus-visible:outline-none dark:border-strokedark dark:bg-slate-800 dark:text-white dark:focus:border-primary i-gmac"
											name="v_access_door_topic"
											placeholder="Tipe Accessdoor"
											onChange={handleChange}
											value={
												formState.v_access_door_topic
											}
											disabled={isDetail}
										/>
										<p className="error-text p-0 m-0">
									...
									<div className="form-group w-full h-22">
										...
										<select
											...
											onChange={handleChange}
											value={formState.status_access_door}
											disabled={isDetail}
										>
