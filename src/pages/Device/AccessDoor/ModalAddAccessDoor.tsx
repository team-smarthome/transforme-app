...
export const AddAccessDoor: React.FC<AddAccessDoorModalProps> = ({ closeModal, onSubmit, defaultValue, isDetail, isEdit }) => {
      ...
      steps: [
        ...
        },
        {
          ...
          popover: {
            ...
            description: "Pilih status desktop yang diinginkan",
          },
        },
        {
          element: ".p-ruang",
              ...
              <div className="w-full flex justify-between">
                <div>
                  <h3 className="text-xl font-semibold text-black dark:text-white">
                    {
                      isDetail ? "Detail Data Accessdoor" : 
                      isEdit ? "Edit Data Accessdoor" : 
