...
import { AddAccessDoor } from "./ModalAddAccessDoor";
import { DeleteAccessdoorModal } from "./ModalDeleteAccessDoor";
import { Alerts } from "./AlertAccessDoor";
import { 
  apiReadGateway, 
  apiDeleteGateway, 
  apiCreateGateway, 
  apiUpdateGateway } from "../../../services/api";
...
const AccessDoorList = () => {
      ...
      steps: [
        {
          ...
          popover: {
            title: "Search",
            description: "Mencari nama Access Door",
          },
        },
        {
          element: "#p-status",
        ...
        },
        {
          ...
          popover: {
            title: "Button Search",
            description: "Click button untuk mencari nama Access Door",
          },
        },
        {
          element: ".excel",
        ...
        },
        {
          ...
          popover: {
            title: "Tambah",
            description: "Menambah data perangkat Access Door",
          },
        },
      ],
    });
  ...
  const exportToExcel = async () => {
    const dataToExcel = [
      ["nama Access Door", "GMAC", "status Access Door", "Nama Lokasi Otmil", "Nama Ruangan Otmil"],
    ...
    xlsx.writeFile(wb, `Data-Access Door ${dayjs(new Date()).format("DD-MM-YYYY HH.mm")}.xlsx`);
  };
    ...
    <div className="container py-[16px]">
      ...
      <div className="rounded-sm border border-stroke bg-white px-5 pt-6 pb-2.5 shadow-default dark:border-strokedark dark:bg-boxdark sm:px-7.5 xl:pb-1">
          ...
          <div className="mb-4 flex gap-2 items-center border-[1px] border-slate-800 px-4 py-2 rounded-md">
            <div className="flex w-full">
              <div className="search">
                <SearchInputButton value={filter} placehorder="Cari nama Access Door" onChange={handleFilterChange} />
              </div>
              <select
        ...
        <div className="flex justify-between items-center mb-3">
          <h4 className="ext-xl font-semibold text-black dark:text-white">Data Perangkat Access Door</h4>
          {!isOperator && (
        ...
        <div className="flex flex-col">
          <div className={`grid  rounded-t-md bg-gray-2 dark:bg-slate-600 ${isOperator ? "grid-cols-5" : "grid-cols-6"}`}>
            <div className="p-2.5 text-center xl:p-5">
              <h5 className="text-sm font-medium uppercase xsm:text-base">Nama Access Door</h5>
            </div>
            <div className="p-2.5 text-center xl:p-5">
              <h5 className="text-sm font-medium uppercase xsm:text-base">Tipe Acces Door</h5>
            </div>
            <div className="p-2.5 text-center xl:p-5">
              <h5 className="text-sm font-medium uppercase xsm:text-base">Zona Waktu</h5>
            </div>
            <div className="p-2.5 text-center xl:p-5">
          ...
          {modalDetailOpen && <AddAccessDoor closeModal={() => setModalDetailOpen(false)} onSubmit={handleSubmitAdd} defaultValue={detailData} isDetail={true} />}
          {modalEditOpen && <AddAccessDoor closeModal={handleCloseEditModal} onSubmit={handleSubmitEdit} defaultValue={editData} isEdit={true} />}
          {modalAddOpen && <AddAccessDoor closeModal={handleCloseAddModal} onSubmit={handleSubmitAdd} />}
          {modalDeleteOpen && <DeleteAccessdoorModal closeModal={handleCloseDeleteModal} onSubmit={handleSubmitDelete} defaultValue={deleteData} />}
        </div>
