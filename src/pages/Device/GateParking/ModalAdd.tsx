...
export const AddGateParking: React.FC<AddGatewayModalProps> = ({
	closeModal,
	onSubmit,
	defaultValue,
	isDetail,
			...
			steps: [
				{
					element: ".i-nama",
					popover: {
						title: "Nama Gate Parking",
						description: "Isi nama gate parking access",
					},
				},
				{
					element: ".i-gmac",
				...
				},
				{
					...
					popover: {
						...
						description: "Pilih status gate parking yang diinginkan",
					},
				},
				{
					element: ".p-ruang",
							...
							<div className="w-full flex justify-between">
								<div>
									<h3 className="text-xl font-semibold text-black dark:text-white">
										{isDetail
											? "Detail Data Gate Parking"
											: isEdit
											? "Edit Data Gate Parking"
											: "Tambah Data Gate Parking"}
									</h3>
								</div>
								...
								<div className="mt-5 grid grid-cols-2 gap-x-5 gap-y-1 justify-normal">
									<div className="form-group w-full h-22">
										...
										<input
											...
											name="nama_gate_parking"
											placeholder="Nama Gate Parking"
											onChange={handleChange}
											value={formState.nama_gate_parking}
											disabled={isDetail}
										/>
									...
									<div className="form-group w-full h-22">
										...
										<select
											...
											onChange={handleChange}
											value={formState.status_gate_parking}
											disabled={isDetail}
										>
