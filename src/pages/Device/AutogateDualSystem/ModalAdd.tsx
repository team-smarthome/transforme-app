...
export const AddAutoGateDual: React.FC<AddGatewayModalProps> = ({
	closeModal,
	onSubmit,
	defaultValue,
	isDetail,
			...
			steps: [
				{
					element: ".i-nama",
					popover: {
						title: "Nama Auto Gate Dual",
						description: "Isi nama auto gate dual",
					},
				},
				{
					element: ".i-gmac",
							...
							<div className="w-full flex justify-between">
								<div>
									<h3 className="text-xl font-semibold text-black dark:text-white">
										{isDetail
											? "Detail Data Auto Gate Dual"
											: isEdit
											? "Edit Data Auto Gate Dual"
											: "Tambah Data Auto Gate Dual"}
									</h3>
								</div>
								...
								<div className="mt-5 grid grid-cols-2 gap-x-5 gap-y-1 justify-normal">
									<div className="form-group w-full h-22">
										...
										<input
											...
											name="nama_autogate_dual"
											placeholder="Nama Auto Gate Dual"
											onChange={handleChange}
											value={formState.nama_autogate_dual}
											disabled={isDetail}
										/>
									...
									<div className="form-group w-full h-22">
										...
										<select
											...
											onChange={handleChange}
											value={formState.status_autogate_dual}
											disabled={isDetail}
										>
