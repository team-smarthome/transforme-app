...
export const AddRegistrationKios: React.FC<AddGatewayModalProps> = ({
	closeModal,
	onSubmit,
	defaultValue,
	isDetail,
			...
			steps: [
				{
					element: ".i-nama",
					popover: {
						title: "Nama Registration Kios",
						description: "Isi nama registration kios access",
					},
				},
				{
					element: ".i-gmac",
				...
				},
				{
					...
					popover: {
						...
						description: "Pilih status registration kios yang diinginkan",
					},
				},
				{
					element: ".p-ruang",
							...
							<div className="w-full flex justify-between">
								<div>
									<h3 className="text-xl font-semibold text-black dark:text-white">
										{isDetail
											? "Detail Data Registration Kios"
											: isEdit
											? "Edit Data Registration Kios"
											: "Tambah Data Registration Kios"}
									</h3>
								</div>
								...
								<div className="mt-5 grid grid-cols-2 gap-x-5 gap-y-1 justify-normal">
									<div className="form-group w-full h-22">
										...
										<input
											...
											name="nama_registration_kios"
											placeholder="Nama Registration Kios"
											onChange={handleChange}
											value={formState.nama_registration_kios}
											disabled={isDetail}
										/>
										<p className="error-text p-0 m-0">
											{errors.map((item) =>
												item === "nama_registration_kios"
													? "Pilih Registration Kios"
													: ""
											)}
										</p>
									</div>
									...
									<div className="form-group w-full h-22">
										...
										<select
											...
											name="status_registration_kios"
											onChange={handleChange}
											value={formState.status_registration_kios}
											disabled={isDetail}
										>
										...
										<p className="error-text">
											{errors.map((item) =>
												item === "status_registration_kios"
													? "Pilih Status Registration Kios"
													: ""
											)}
										</p>
									</div>
