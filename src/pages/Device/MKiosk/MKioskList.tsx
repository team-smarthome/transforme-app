...
import { AddMKiosk } from "./ModalAddMKiosk";
import { DeleteMKioskModal } from "./ModalDeleteMKiosk";
import { Alerts } from "./AlertMKiosk";
import { 
  apiReadGateway, 
  apiDeleteGateway, 
  apiCreateGateway, 
...
const MKioskList = () => {
      ...
      steps: [
        {
          ...
          popover: {
            title: "Search",
            description: "Mencari nama m-kiosk",
          },
        },
        {
          element: "#p-status",
        ...
        },
        {
          ...
          popover: {
            title: "Button Search",
            description: "Click button untuk mencari nama m-kiosk",
          },
        },
        {
          element: ".excel",
        ...
        },
        {
          ...
          popover: {
            title: "Tambah",
            description: "Menambah data perangkat dekstop",
          },
        },
      ],
    });
  ...
  const exportToExcel = async () => {
    const dataToExcel = [
      ["nama m-kiosk", "GMAC", "status m-kiosk", "Nama Lokasi Otmil", "Nama Ruangan Otmil"],
    ...
    xlsx.writeFile(wb, `Data-M-Kiosk ${dayjs(new Date()).format("DD-MM-YYYY HH.mm")}.xlsx`);
  };
    ...
    <div className="container py-[16px]">
      ...
      <div className="rounded-sm border border-stroke bg-white px-5 pt-6 pb-2.5 shadow-default dark:border-strokedark dark:bg-boxdark sm:px-7.5 xl:pb-1">
          ...
          <div className="mb-4 flex gap-2 items-center border-[1px] border-slate-800 px-4 py-2 rounded-md">
            <div className="flex w-full">
              <div className="search">
                <SearchInputButton value={filter} placehorder="Cari nama M-Kiosk" onChange={handleFilterChange} />
              </div>
              <select
        ...
        <div className="flex justify-between items-center mb-3">
          <h4 className="ext-xl font-semibold text-black dark:text-white">Data Perangkat M-Kiosk</h4>
          {!isOperator && (
        ...
        <div className="flex flex-col">
          <div className={`grid  rounded-t-md bg-gray-2 dark:bg-slate-600 ${isOperator ? "grid-cols-5" : "grid-cols-5"}`}>
            <div className="p-2.5 text-center xl:p-5">
              <h5 className="text-sm font-medium uppercase xsm:text-base">Nama M-Kiosk</h5>
            </div>
            <div className="p-2.5 text-center xl:p-5">
              <h5 className="text-sm font-medium uppercase xsm:text-base">Jenis M-Kiosk</h5>
            </div>
            <div className="p-2.5 text-center xl:p-5">
          ...
          {modalDetailOpen && <AddMKiosk closeModal={() => setModalDetailOpen(false)} onSubmit={handleSubmitAdd} defaultValue={detailData} isDetail={true} />}
          {modalEditOpen && <AddMKiosk closeModal={handleCloseEditModal} onSubmit={handleSubmitEdit} defaultValue={editData} isEdit={true} />}
          {modalAddOpen && <AddMKiosk closeModal={handleCloseAddModal} onSubmit={handleSubmitAdd} />}
          {modalDeleteOpen && <DeleteMKioskModal closeModal={handleCloseDeleteModal} onSubmit={handleSubmitDelete} defaultValue={deleteData} />}
        </div>
