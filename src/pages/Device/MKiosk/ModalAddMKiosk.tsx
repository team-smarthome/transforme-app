...
export const AddMKiosk: React.FC<AddMKioskModalProps> = ({ closeModal, onSubmit, defaultValue, isDetail, isEdit }) => {
              ...
              <div className="w-full flex justify-between">
                <div>
                  <h3 className="text-xl font-semibold text-black dark:text-white">
                    {
                    isDetail ? "Detail Data M-Kiosk" : 
                    isEdit ? "Edit Data M-Kiosk" : "Tambah Data M-Kiosk"
                    }
                  </h3>
                </div>
