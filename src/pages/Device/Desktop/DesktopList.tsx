...
import { AddDesktop } from "./ModalAddDesktop";
...
const GatewayList = () => {
      ...
      steps: [
        {
          ...
          popover: {
            title: "Search",
            description: "Mencari nama dekstop",
          },
        },
        {
          element: "#p-status",
        ...
        },
        {
          ...
          popover: {
            title: "Button Search",
            description: "Click button untuk mencari nama dekstop",
          },
        },
        {
          element: ".excel",
  ...
  const exportToExcel = async () => {
    ...
    xlsx.writeFile(wb, `Data-Desktop ${dayjs(new Date()).format("DD-MM-YYYY HH.mm")}.xlsx`);
  };
        ...
        <div className="flex flex-col">
          <div className={`grid  rounded-t-md bg-gray-2 dark:bg-slate-600 ${isOperator ? "grid-cols-5" : "grid-cols-6"}`}>
            <div className="p-2.5 text-center xl:p-5">
              <h5 className="text-sm font-medium uppercase xsm:text-base">Nama Desktop</h5>
            </div>
            <div className="p-2.5 text-center xl:p-5">
              <h5 className="text-sm font-medium uppercase xsm:text-base">Model</h5>
            </div>
            <div className="p-2.5 text-center xl:p-5">
            ...
            <div className="p-2.5 text-center xl:p-5">
              <h5 className="text-sm font-medium uppercase xsm:text-base">Nomor Seri</h5>
            </div>
          ...
          {modalDetailOpen && <AddDesktop closeModal={() => setModalDetailOpen(false)} onSubmit={handleSubmitAdd} defaultValue={detailData} isDetail={true} />}
          {modalEditOpen && <AddDesktop closeModal={handleCloseEditModal} onSubmit={handleSubmitEdit} defaultValue={editData} isEdit={true} />}
          {modalAddOpen && <AddDesktop closeModal={handleCloseAddModal} onSubmit={handleSubmitAdd} />}
          {modalDeleteOpen && <DeleteDesktopModal closeModal={handleCloseDeleteModal} onSubmit={handleSubmitDelete} defaultValue={deleteData} />}
        </div>
