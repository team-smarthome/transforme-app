...
import { AddMesinXray } from "./ModalAdd";
			...
			steps: [
				{
					...
					popover: {
						title: "Search",
						description: "Mencari nama Mesin Xray",
					},
				},
				{
					element: "#p-status",
				...
				},
				{
					...
					popover: {
						title: "Button Search",
						description: "Click button untuk mencari nama Mesin Xray",
					},
				},
				{
					element: ".excel",
				...
				},
				{
					...
					popover: {
						title: "Tambah",
						description: "Menambah data mesin xray",
					},
				},
			],
		});
					...
					<div className="mb-4 flex gap-2 items-center border-[1px] border-slate-800 px-4 py-2 rounded-md">
						<div className="flex w-full">
							<div className="search">
								<SearchInputButton
									value={filter}
									placehorder="Cari nama Mesin Xray"
