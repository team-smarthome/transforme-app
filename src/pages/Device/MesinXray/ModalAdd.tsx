...
export const AddMesinXray: React.FC<AddGatewayModalProps> = ({
	closeModal,
	onSubmit,
	defaultValue,
	isDetail,
			...
			steps: [
				{
					element: ".i-nama",
					popover: {
						title: "Nama Mesin Xray",
						description: "Isi nama mesin xray access",
					},
				},
				{
					element: ".i-gmac",
				...
				},
				{
					...
					popover: {
						...
						description: "Pilih status mesin xray yang diinginkan",
					},
				},
				{
					element: ".p-ruang",
							...
							<div className="w-full flex justify-between">
								<div>
									<h3 className="text-xl font-semibold text-black dark:text-white">
										{isDetail
											? "Detail Data Mesin Xray"
											: isEdit
											? "Edit Data Mesin Xray"
											: "Tambah Data Mesin Xray"}
									</h3>
								</div>
