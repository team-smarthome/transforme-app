  ...
  return loading ? (
    ...
    <div className="p-4 md:p-6 2xl:p-10">
      ...
      <div className="flex gap-150">
        <div className="mt-8 font-semibold text-2xl">Kasus</div>
        <MdOutlineAddCircleOutline
      ...
      <div className=" flex justify-center w-full mt-4 md:mt-6 md:gap-6 2xl:mt-7.5 2xl:gap-7.5">
        <div className="w-1/2">
          <ChartFive />
        </div>
      ...
      <div className="mt-8 xl:flex xl:space-x-2">
        <div className="mt-2 xl:w-1/2 md:w-full ">
          <div className="flex justify-between">
            ...
            <MdOutlineAddCircleOutline
              ...
              size={35}
              onClick={() =>
                navigate("/workstation/pengaturan-list/perangkat/kamera")
              }
            />
          </div>
        ...
        <div className="mt-2 xl:w-1/2 md:w-full">
          <div className="flex justify-between">
            <h1 className="font-semibold text-2xl">Gelang</h1>
            <MdOutlineAddCircleOutline
              className="mr-2 hover:cursor-pointer hover:text-slate-400"
              size={35}
              onClick={() =>
                navigate("/workstation/pengaturan-list/perangkat/gelang")
              }
            />
          </div>
          <div className="mt-2">
      ...
      <div>
        <div className="flex justify-between">
          ...
          <MdOutlineAddCircleOutline
            ...
            size={35}
            onClick={() =>
              navigate("/workstation/pengaturan-list/perangkat/gateway")
            }
          />
        </div>
        <Gateway />
